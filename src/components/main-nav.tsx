...
export default async function MainNav({
  ...
  const filteredSports = sports.filter((s) =>
    ["Soccer", "Tennis", "Basketball"].includes(s.strSport)
  );
